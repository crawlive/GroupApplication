/*
 * AddCourseModel.java - Model for adding courses
 */
...
public class AddCourseModel extends MainModel {
	 ...
	 * addCourse
	 *
	 * add a new course to the the courses arraylist, throw alerts for existing and
	 * completion
	 */
	 ...
	 * 
	 * @param the course to create the button for
	 */
	 ...
	 * getColor
	 *
	 * gets the color of a given course
	 * 
	 * @param the course to retrieve the color for
	 */
	...
	public static String findAbbreviation(String name) {
		String abbreviation;
		if (name.contains(" ")) {
			abbreviation = name.replaceAll("\\B.|\\P{L}", "").toUpperCase(); // only letters which are at the beginning
																				// of a word
		} else {
